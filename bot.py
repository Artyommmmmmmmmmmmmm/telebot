...
def description(message):
    bot.send_message(message.chat.id, 'Для использования бота введите сообщение в формате\nвалюта1 валюта2 количество\n \
бот переведёт (количество) валюты1 в валюту2\n \
...
git remote add origin https://github.com/Artyommmmmmmmmmmmmm/telebot.git
git branch -M main
